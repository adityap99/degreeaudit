        ...
        {!this.state.renderResult || !this.props.renderSetCustomFilterResult ?
          <div className='admin--set_custom_filter--container'>
            <div className='admin--set_custom_filter--wrapper'>
              <div className='admin--set_custom_filter--batch'>
            <span>
              Batch :
            </span>
            ...
            />*/}
              ...
              <span className='admin--set_custom_filter--CPI--text'>
                ...
                <span style={{
                  ...
                  <input
                  className='admin--set_custom_filter--CPI--input'
                  type="text"
              ...
              >
                ...
                {(this.state.setcustomfilterbuttonclicks)?<span className={'denied'}>Sorry, no student satisfying such criteria is found</span>:<span> </span>}
